...
import { bajaReferencia, getReferencias } from "@/services/referenciaService";
      ...
      <div className="w-full flex justify-between items-center border-b mb-3 pb-3">
        <div className="flex items-center gap-4">
          <Button
            ...
            onClick={() => navigate("/referencias/crear")}
          >
            <span>Agregar</span>
            <PlusIcon className="h-5 w-5" />
          </Button>
          <h1 className="text-xl font-bold">Lista de Referencias</h1>
        </div>
            ...
            <TableRow key={emp.id}>
              ...
              <TableCell className="flex gap-2 py-2 justify-end">
                ...
                <TooltipProvider delayDuration={0}>
                  <Tooltip disableHoverableContent>
                    <TooltipTrigger>
                      <Button variant="outline" size="sm" className="text-yellow-600 hover:bg-yellow-700 hover:text-white" onClick={() => navigate(`/referencia/${emp.id}`)}>
